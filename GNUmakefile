...
# Configurations
CCFLAGS     = -std=c++17 -fPIC -O3 -fopenmp #-Wall -Wextra -Wpedantic
LIBS        = -lgomp #-lblas
...
+quadriga_lib/arrayant_interpolate.mex:   build/quadriga_lib.o   build/quadriga_tools.o   build/qd_arrayant_interpolate.o
+quadriga_lib/arrayant_qdant_read.mex:   build/quadriga_lib.o   build/qd_arrayant_qdant.o
...
+quadriga_lib/arrayant_interpolate.mexa64:   build/quadriga_lib.o   build/quadriga_tools.o   build/qd_arrayant_interpolate.o
+quadriga_lib/arrayant_qdant_read.mexa64:   build/quadriga_lib.o   build/qd_arrayant_qdant.o
