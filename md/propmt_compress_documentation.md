...
- Do not include "template <typename dtype>", instead, add a note in the description: "Allowed datatypes: float or double"
...
- Link to the class itself should be [[class_name]], not [[quadriga_lib::class_name]].
