...
- **`e_theta_im`**<br>
  Imaginary part of the e-theta component of the electric field. Single or double precision, <br>
...
- **`e_phi_im`**<br>
  Imaginary part of the e-phi component of the electric field. Single or double precision, <br>
  Size: `[n_elevation, n_azimuth, n_elements]`
  
- **`azimuth_grid`**<br>
  Azimuth angles (theta) in [rad] were samples of the field patterns are provided. Values must be
  between -pi and pi, sorted in ascending order. Single or double precision, <br>
  Size: `[1, n_azimuth]` or `[n_azimuth, 1]`
  
- **`elevation_grid`**<br>
  Elevation angles (phi) in [rad] where samples of the field patterns are provided. Values must be
  between -pi/2 and pi/2, sorted in ascending order. Single or double precision, <br>
  Size: `[1, n_elevation]` or `[n_elevation, 1]`
