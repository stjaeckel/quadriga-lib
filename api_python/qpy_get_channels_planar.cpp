...
- **`aod`** (required)<br>
  Departure azimuth angles in [rad], Size: `[ n_path ]`

- **`eod`** (required)<br>
  Departure elevation angles in [rad], Size: `[ n_path ]`

- **`aoa`** (required)<br>
  Arrival azimuth angles in [rad], Size: `[ n_path ]`

- **`eoa`** (required)<br>
  Arrival elevation angles in [rad], Size: `[ n_path ]`
