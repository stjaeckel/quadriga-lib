...
assertEqual( size(mtl_prop), [12,9] );
...
assertTrue( all(all( mtl_prop(:,2:8) == 0 )) );
assertTrue( all( mtl_prop(:,9) == 1 ) );            % fRef = 1 GHz
...
assertElementsAlmostEqual( mtl_prop(1,:), [1.1, 1.2, 1.3, 1.4, 10, 0, 0, 0, 1], 'absolute', 1e-14 );
assertElementsAlmostEqual( mtl_prop(2,:), [2.1, 2.2, 2.3, 2.4, 20, 0, 0, 0, 1], 'absolute', 1e-14 );
